  ...
  componentWillMount() {
    try {
      ...
      setTimeout(() => {
        ...
        setTimeout(() => {
          log(`DataFromStreamEvent componentWillMount ${window.location.href} ${this.props.streameventname}`);
          intBcVideo.addStreamEventListener('%20-%20/event', this.props.streameventname, this.handleStreamEvent);
          log('DataFromStreamEvent componentWillMount end');
        }, 200);
      }, 200);
      /*
